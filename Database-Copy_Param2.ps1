...
$Newdbname = 'test2020'
$mail = 'mattias.gunnmo@saabgroup.com'
$mail2 = 'mattias.gunnmo@saabgroup.com'
...
$subject2 = 'The database ' + $database + ' has now been copied to ' + $targetserver + ' as ' + $Newdbname + 'copy ok' 
...
$subject2 | Add-Content -Path 'c:\temp\copy.txt

Send-MailMessage -From 'MSSQL@saabgroup.com' -To $mail2 -Subject $subject2 -SmtpServer $smtpserver 
<#
