...
$Sourceserver = "SSPDB4PROD" #"SSPDB4PROD"
$databases = Import-Csv -Path C:\scripts\SESP_databases4PROD.csv
$Targetserver = "SSPDB16495"  #"SSPDB16895"
...
$logfile = 'C:\scripts\SSPDB16495.txt'
$sqlinstance1 = 'SSPDB4PROD,11433'
$sqlinstance2 = 'SSPDB16495,11433'
